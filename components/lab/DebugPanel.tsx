...
export default function DebugPanel() {
  useControls(() => ({
    ...
    Splat: folder({
      ...
      microRatio:       num('microRatio', 0.05, 0.40, 0.01, true),
      mediumRatio:      num('mediumRatio', 0.30, 0.80, 0.01, true),
      largeRatio:       num('largeRatio', 0.05, 0.40, 0.01, true),
      sizeScale:        num('sizeScale', 0.3, 2.5, 0.05),
      gaussianSoftness: num('gaussianSoftness', 0.4, 2.5, 0.05),
      opacity:          num('opacity', 0.05, 1.5, 0.01),
      reflectance:      num('reflectance', 0.05, 1.5, 0.01),
    ...
    Debug: folder({
      view: {
        ...
        options: ['composite', 'background', 'light', 'fog', 'splat', 'velocity', 'masks', 'depth'],
        transient: true,
