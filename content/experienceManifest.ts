...
export type ExperienceChapter = {
  ...
  accent: string
  assetSlots: string[]
  /** 이 역량을 증명하는 Works 프로젝트 id.
      WorksFilm의 field 문구에서 유추한 값이므로 실제 수행 범위와 대조가 필요하다. */
  evidenceProjects?: string[]
  /** 이 역량이 푸는 관람객·고객의 문제. 확인된 문장이 없으면 비워 둔다. */
  problem?: string
}
...
export const EXPERIENCE_CHAPTERS: ExperienceChapter[] = [
  ...
  { id: 'dorothy', number: '01', character: '도로시', role: 'PLANNING & DESIGN', headline: '아이디어가\n공간을 설계합니다.', description: '방문자의 여정을 관찰하고 콘텐츠·동선·매체를 하나의 경험 구조로 설계합니다.', accent: '#ffb47f', evidenceProjects: ['expo', 'hospital'], assetSlots: ['dorothy-environment', 'dorothy-character'] },
  { id: 'scaremuse', number: '02', character: 'ScareMuse', role: 'IMMERSIVE MEDIA', headline: '이야기가 공간 전체로\n펼쳐집니다.', description: '영상·빛·사운드가 관람 동선과 만나 하나의 몰입 장면을 만듭니다.', accent: '#91efc8', evidenceProjects: ['expo', 'immersive', 'apec'], assetSlots: ['scaremuse-transition', 'chapter-posters'] },
  { id: 'roarlink', number: '03', character: 'RoarLink', role: 'INTERACTIVE MEDIA', headline: '공간의 주인공은\n언제나 당신입니다.', description: '사용자의 움직임과 선택이 공간을 작동시키고 새로운 장면을 엽니다.', accent: '#ffad66', evidenceProjects: ['sports', 'forest'], assetSlots: ['roarlink-transition', 'chapter-posters'] },
  { id: 'tinai', number: '04', character: 'TinAI', role: 'AI PRODUCTION & SOLUTION', headline: 'AI가 공간을\n진화시킵니다.', description: '기술을 드러내기보다 행동을 감지하고 경험을 조직하는 보이지 않는 생명력으로 사용합니다.', accent: '#8fd8ff', evidenceProjects: ['hospital'], assetSlots: ['tinai-transition', 'chapter-posters'] },
